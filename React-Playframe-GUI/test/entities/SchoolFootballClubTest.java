...
public class SchoolFootballClubTest {
    SchoolFootballClub testClub = new SchoolFootballClub("TestClub","TestLocation",
            0,0,0,0,0,0,0,0,
            "TestSchool","schoolRegion");
    @Test
    public void TestClub(){
        ...
        int passTest = 0;
        String [] testStrings = {"Liverpool","Anfield","RichHalt","NorthEast"};
        ...
        testClub.setSchoolName(testStrings[2]);
        testClub.setSchoolRegion(testStrings[3]);
        ...
        if (testStrings[2].equals(testClub.getSchoolName())){
            passTest++;
        }
        if (testStrings[3].equals(testClub.getSchoolRegion())){
            passTest++;
        }
